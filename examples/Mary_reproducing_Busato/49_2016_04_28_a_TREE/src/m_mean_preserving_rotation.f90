...
! Creating the random orthonormal mean preserving nrens x nrens Upb matrix: Up=B^T Upb B
   call dgemm('n','n',nrens,nrens,nrens,1.0d0,B,nrens,Upb,nrens,0.0d0,Q,nrens)
   call dgemm('n','t',nrens,nrens,nrens,1.0d0,Q,nrens,B,nrens,0.0d0,Up,nrens)

...
C  ------------------- Start Newton - Raphson iteration --------------------  
     ...
     1              *(PSILMEAN-LA_PSILMAX(ITYPE))**2)
         ...
         E22 = 0
         DO I=1,DATA_LEAF(ITYPE)
             GSTOMA1(NP,I)= A1(I)/(A2(I)+SSTOMA*CCO2ATM)*
     1                     (-1+SQRT(CCO2ATM/(ASTOMA*LASTOMA1*VPD)))
     2                     +GS_NIGHT
             GSTOMA2(NP,I)= A1(I)/(A2(I)+SSTOMA*CCO2ATM)*
     1                     (-1+SQRT(CCO2ATM/(ASTOMA*LASTOMA2*VPD)))
     2                     +GS_NIGHT

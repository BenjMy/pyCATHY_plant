...
C
      ...
      REAL*8   PTNEW(*),PTIMEP(*)
      REAL*8   TNOTI(*),XT5(*),LHSP(*),COEF1(*),COEF2(*)
...
C
      CALL TIM(CPUL1,1)
      CALL RHSPIC(N,JA,TOPOL,DELTAT,PTNEW,PNEW,
...
C
      CALL TIM(CPUL1,1)
      CALL CFMATP(NTERM,TETAF,DELTAT,COEF1,COEF2)
      CALL TIM(CPUL1,2)
...
C
      CALL BCPIC(N,NP,NQ,CONTP,CONTQ,LHSP,Q,NNOD,
